...
it('should save a user', async () => {
  ...
  })) as Pick<User, 'id' | 'email' | 'password' | 'balance'>
...
it('should require a password with at least one capital letter', async () => {
  await expect(
    signup({
      email: 'user2@domain.com',
      password: 'password.123',
...
it('should require a password with at least one number', async () => {
  await expect(
    signup({
      email: 'user2@domain.com',
